        ...
        If includePaths AndAlso includeExecutable Then
            ...
            Select Case Decoder.ValueText.ToLowerInvariant()
                ...
                Case "ffqsv"
                    ...
                    sb.Append(Package.ffmpeg.Path.Escape + " -threads 1 -hwaccel qsv -i " + p.SourceFile.Escape + " -f yuv4mpegpipe -pix_fmt " + pix_fmt + " -strict -1" + crop + " -loglevel fatal -hide_banner - | " + Package.AOMEnc.Path.Escape)
                    If isSingleChunk Then
                        If Skip.Value > 0 Then
                            sb.Append($" --skip={Skip.Value}")
                        End If
