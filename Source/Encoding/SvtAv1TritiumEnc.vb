...
Public Class SvtAv1TritiumEnc
    ...
    Overloads Shared ReadOnly Property Package As Package
        Get
            Return Package.SvtAv1EncAppTritium
        End Get
    End Property

    <NonSerialized>
    Private ParamsValue As SvtAv1TritiumEncParams

    Property Params As SvtAv1TritiumEncParams
        Get
            If ParamsValue Is Nothing Then
                ParamsValue = New SvtAv1TritiumEncParams
                ParamsValue.Init(ParamsStore)
            End If

            Return ParamsValue
        End Get
        Set(value As SvtAv1TritiumEncParams)
            ParamsValue = value
        End Set
    End Property
    ...
    Overrides Sub RunCompCheck()
        ...
        Dim newParams As New SvtAv1TritiumEncParams
        Dim newStore = ObjectHelp.GetCopy(ParamsStore)
        newParams.Init(newStore)

        Dim enc As New SvtAv1TritiumEnc
    ...
    Overrides Function CreateEditControl() As Control
        Return New SvtAv1EncAppTritiumControl(Me) With {.Dock = DockStyle.Fill}
    End Function
    ...
    Overrides Sub ShowConfigDialog(Optional param As CommandLineParam = Nothing)
        ...
        Using form As New CommandLineForm(newParams)
            ...
            Dim a = Sub()
                        ...
                        Dim params2 As New SvtAv1TritiumEncParams
    ...
    Shared Function Test() As String
        ...
        tester.CodeFile = Path.Combine(Folder.Startup.Parent, "Encoding", "SvtAv1TritiumEnc.vb")

        Return tester.Test
    End Function
End Class

Public Class SvtAv1TritiumEncParams
    Inherits CommandLineParams

    Sub New()
        Title = "SvtAv1EncApp (SVT-AV1-Tritium) Options"
    End Sub

    Public Overrides ReadOnly Property Package As Package
        Get
            Return SvtAv1TritiumEnc.Package
        End Get
    End Property
    ...
    Property Tune As New OptionParam With {
        ...
        .Expanded = True,
        .IntegerValue = True,
        .Options = {"0: VQ", "1: PSNR (default)", "2: SSIM", "3: Image Quality", "4: MS-SSIM/SSIMULACRA2", "5: Film Grain"},
        .Init = 1}
    ...
    Property AltLambdaFactors As New OptionParam With {
