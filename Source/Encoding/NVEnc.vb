...
Public Class NVEnc
    ...
    <NonSerialized>
    Private ParamsValue As NVEncParams

    Property Params As NVEncParams
        Get
            If ParamsValue Is Nothing Then
                ParamsValue = New NVEncParams
                ParamsValue.Init(ParamsStore)
            End If

            Return ParamsValue
        End Get
        Set(value As NVEncParams)
            ParamsValue = value
        End Set
    End Property
    ...
    Overrides Sub ShowConfigDialog(Optional param As CommandLineParam = Nothing)
        Dim newParams As New NVEncParams
        ...
        Using form As New CommandLineForm(newParams)
            ...
            Dim a = Sub()
                        ...
                        Dim params2 As New NVEncParams
    ...
    Overrides Function CreateEditControl() As Control
        Return New NVEncControl(Me) With {.Dock = DockStyle.Fill}
    End Function

    Overrides Property QualityMode() As Boolean
        Get
            Return Params.Mode.Value = NVEncRateMode.QVBR OrElse Params.Mode.Value = NVEncRateMode.CQP
        End Get
        Set(Value As Boolean)
        End Set
    End Property
...
Public Class NVEncParams
    ...
    Property Bitrate As New NumParam With {
        ...
        .Text = "Bitrate",
        .Init = 5000,
        .VisibleFunc = Function() Mode.Value > NVEncRateMode.CQP,
    ...
    Property VbrQuality As New NumParam With {
        ...
        .Config = {0, 51, 0.5, 1},
        .Init = 0,
        .VisibleFunc = Function() Mode.Value = NVEncRateMode.VBR}
    ...
    Property QP As New NumParam With {
        ...
        .Text = "QP",
        .Init = 18,
        .VisibleFunc = Function() Mode.Value = NVEncRateMode.CQP AndAlso Codec.Value <> 2 AndAlso Not (QPAdvanced.Value AndAlso QPAdvanced.Visible),
        .Config = {0, 63}}
    ...
    Function GetModeArgs() As String
        Select Case Mode.Value
            ...
            Case NVEncRateMode.CBR
                Return "--cbr " & Bitrate.Value.ToInvariantString()
            Case NVEncRateMode.VBR
