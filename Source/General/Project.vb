...
Public Class Project
    ...
    Public AutoCropDolbyVisionSideMode As AutoCropDolbyVisionSideMode = AutoCropDolbyVisionSideMode.NoOverride
    ...
    Public CompCheckAction As CompCheckAction = CompCheckAction.AdjustFileSize
    ...
    Sub Init() Implements ISafeSerialization.Init
        ...
        If Check(PreferredSubtitles, "Automatically Included Subtitles", 2) Then
            PreferredSubtitles = If(Language.CurrentCulture.TwoLetterCode = "en", "eng und all", Language.CurrentCulture.ThreeLetterCode + " eng und all")
        End If
