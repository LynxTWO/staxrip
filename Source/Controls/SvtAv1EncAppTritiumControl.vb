...
Public Class SvtAv1EncAppTritiumControl
...
#Region " Designer "
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "SvtAv1EncAppTritiumControl"
...
#End Region
    ...
    Private ReadOnly Encoder As SvtAv1TritiumEnc
    Private ReadOnly Params As SvtAv1TritiumEncParams
    Private ReadOnly cms As ContextMenuStripEx
    Private ReadOnly QualityDefinitions As List(Of SvtAv1EncAppControl.QualityItem)

    Sub New(enc As SvtAv1TritiumEnc)
        InitializeComponent()
