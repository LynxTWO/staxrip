...
internal static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        TestCase[] cases = selfTestFailure
            ...
            : ContractCases.All.Concat(MediaFactsCases.All).Concat(BoundedProcessCases.All).Concat(MediaInfoCliCases.All).Concat(MediaPathPolicyCases.All).Concat(MediaFileProbeCases.All).Concat(ServerCases.All).ToArray();
