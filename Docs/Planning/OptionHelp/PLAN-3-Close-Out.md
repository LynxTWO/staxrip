...
- Maintainer decisions recorded above: the legacy `.Help` strings (a21); whether the stale switches leave the dialog (a4); whether `svt-av1.rc` or `svt-av1.tbr` should mention the VBR run-to-run variance (b14).
